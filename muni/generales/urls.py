...
from .views import CustomLoginView, DashboardView, EncuestasView, GeneralesDashboardView, NewsView, PersonalizacionView, ReportesView, SeccionesView, ServicioCreateView, ServicioUpdateView,SocialMediaView,ServicesView, UsuarioCreateView, UsuarioEditView, UsuarioEditView, UsuariosView, VideoView, actualizar_video, create_social_network, custom_upload_function, agregar_categoria, delete_social_network, eliminar_noticia, editar_noticia, list_social_networks, toggle_favorite, toggle_user_status
